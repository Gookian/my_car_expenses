...
class CreateWashExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateWashExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.washExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на мойку", behaviorScreen: BehaviorScreen.create),
    );
  }
}
