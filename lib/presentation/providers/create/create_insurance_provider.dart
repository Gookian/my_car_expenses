...
class CreateInsuranceProvider extends StatelessWidget {
  final int? carId;
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.insurance, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление страховки", behaviorScreen: BehaviorScreen.create),
    );
  }
}
