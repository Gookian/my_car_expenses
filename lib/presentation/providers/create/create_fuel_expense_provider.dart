...
class CreateFuelExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateFuelExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.fuelExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на заправку", behaviorScreen: BehaviorScreen.create),
    );
  }
}
