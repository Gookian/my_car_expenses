...
class CreateTuningExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateTuningExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.tuningExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на тюнинг", behaviorScreen: BehaviorScreen.create),
    );
  }
}
