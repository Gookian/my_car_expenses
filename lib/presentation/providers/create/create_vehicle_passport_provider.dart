...
class CreateVehiclePassportProvider extends StatelessWidget {
  final int? carId;

  const CreateVehiclePassportProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.vehiclePassport, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление ПТС", behaviorScreen: BehaviorScreen.create),
    );
  }
}
