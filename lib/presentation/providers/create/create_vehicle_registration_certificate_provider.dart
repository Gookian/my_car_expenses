...
class CreateVehicleRegistrationCertificateProvider extends StatelessWidget {
  final int? carId;

  const CreateVehicleRegistrationCertificateProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.vehicleRegistrationCertificate, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление СТС", behaviorScreen: BehaviorScreen.create),
    );
  }
}
