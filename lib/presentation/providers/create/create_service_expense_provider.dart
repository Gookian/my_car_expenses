...
class CreateServiceExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateServiceExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.serviceExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на сервис", behaviorScreen: BehaviorScreen.create),
    );
  }
}
