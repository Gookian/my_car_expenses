...
class CreateOtherExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateOtherExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.otherExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление других затрат", behaviorScreen: BehaviorScreen.create),
    );
  }
}
