...
class CreateTowTruckExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateTowTruckExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.towTruckExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на эвакуатор", behaviorScreen: BehaviorScreen.create),
    );
  }
}
