...
class CreateTollRoadExpenseProvider extends StatelessWidget {
  final int? carId;

  const CreateTollRoadExpenseProvider({
    super.key,
    required this.carId
  });
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CreateCubit>(
      create: (context) => GetIt.instance<CreateCubit>(param1: CreateCubitType.tollRoadExpense, param2: carId)..loadStructure(),
      child: CreateScreen(title: "Добавление затрат на платную дорогу", behaviorScreen: BehaviorScreen.create),
    );
  }
}
